...
def parse_args():
    ...
    parser.add_argument("--workspace_dir", type=str, default='/media/w/dataset/SMAT')  # workspace dir
    parser.add_argument("--data_dir", type=str, default='/media/w/dataset/')
    parser.add_argument("--save_dir", type=str, default='/media/w/dataset/SMAT/output')

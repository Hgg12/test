...
dataset_dict = dict(
    ...
    lasot_extension_subset=DatasetInfo(module=pt % "lasotextensionsubset", class_name="LaSOTExtensionSubsetDataset",
                                       kwargs=dict()),
    wildlife2024_test=DatasetInfo(module=pt % "wildlife2024", class_name="Wildlife2024Dataset", kwargs=dict()),
    watb = DatasetInfo(module=pt % 'watb', class_name="WATBDataset", kwargs=dict()),
    add = DatasetInfo(module=pt % 'add', class_name="AddDataset", kwargs=dict()),
